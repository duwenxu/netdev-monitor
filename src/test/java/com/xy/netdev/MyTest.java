...
public class MyTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String targetIp = "192.6.6.167";
        String oid2="1.3.6.1.4.1.63000.2.2.2.16.69.1.1.4";
        String oid1="1.3.6.1.4.1.63000.2.2.2.16.69.1.1.12";
        String oid3="1.3.6.1.4.1.63000.2.2.2.16.69.1.1.13";
        String oid4="1.3.6.1.4.1.63000.2.2.2.16.69.1.1.14";
