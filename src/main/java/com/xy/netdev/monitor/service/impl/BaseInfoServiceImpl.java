...
public class BaseInfoServiceImpl extends ServiceImpl<BaseInfoMapper, BaseInfo> implements IBaseInfoService {
    ...
    public Map<String, Object> downDevFile(String devNo) {
        ...
        maps.put("fileName", "P[" + ByteUtils.make0HexStr(sysParamService.getParaRemark1(DEV_COMMON_TYPE_CODE)) + subType + "]_" + DateUtils.getDateYMDHMS());
    ...
    private String generateDevModelFileMap(BaseInfo baseInfo) {
        ...
        //给dev节点增加属性值
        devMap.put("-Types", ByteUtils.make0HexStr(sysParamService.getParaRemark1(DEV_COMMON_TYPE_CODE)));
