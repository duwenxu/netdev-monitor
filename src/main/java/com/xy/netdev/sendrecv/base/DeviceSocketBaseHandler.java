 ...
 * @author cc
 */
public abstract class DeviceSocketBaseHandler<T extends FrameReqData, R extends FrameRespData>
        implements DeviceSocketService<T, R>, ProtocolActionService<T, R> {
