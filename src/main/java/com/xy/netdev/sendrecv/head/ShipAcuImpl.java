...
@Service
@Slf4j
public class ShipAcuImpl extends AbsDeviceSocketHandler<SocketEntity, FrameReqData, FrameRespData> {
    ...
    public FrameRespData unpack(SocketEntity socketEntity, FrameRespData frameRespData) {
        ...
        if (FRAME_HEAD.equals(headFrame) && FRAME_END.equals(endFrame)){
            ...
            log.warn("1.5米ACU天线响应数据帧头帧尾错误, 未能正确解析, 数据体长度:{}, 数据体:{}", bytes.length, HexUtil.encodeHexStr(bytes));
            return frameRespData;
        }
        //数据体
