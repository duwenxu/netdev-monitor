...
@Service
@Slf4j
public class Ka100BucImpl extends AbsDeviceSocketHandler<SocketEntity, FrameReqData, FrameRespData> {
    ...
    public FrameRespData unpack(SocketEntity socketEntity, FrameRespData frameRespData) {
        ...
        if(endOffset>beginOffset){
            ...
            log.error("华达Ka100W功放返回数据异常：{}",data);
        }
    ...
    public byte[] pack(FrameReqData frameReqData) {
        ...
        log.debug("华达Ka100W功放发送查询/控制帧：[{}]",StrUtil.str(paramBytes, StandardCharsets.UTF_8));
        return paramBytes;
    }
