...
@Service
@Slf4j
public class SixSwitchImpl extends AbsDeviceSocketHandler<SocketEntity, FrameReqData, FrameRespData> {
    ...
    public byte[] pack(FrameReqData frameReqData) {
        ...
        log.debug("六选一开关发送查询/控制帧：[{}]",StrUtil.str(paramBytes, StandardCharsets.UTF_8));
        return paramBytes;
    }
