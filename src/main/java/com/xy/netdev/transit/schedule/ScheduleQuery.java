...
//        List<BaseInfo> queryBaseInfo = ScheduleQueryHelper.getAvailableBases().stream().filter(base -> base.getDevType().equals("0020040")).collect(Collectors.toList());
        //一类车船载
        List<BaseInfo> queryBaseInfo = ScheduleQueryHelper.getAvailableBases().stream().filter(base -> base.getDevType().equals("0020006") || base.getDevType().equals("0020007") || base.getDevType().equals("0020010") || base.getDevType().equals("0020008") || base.getDevType().equals("0020014") || base.getDevType().equals("0020017") || base.getDevType().equals("0020018")).collect(Collectors.toList());
        //一类车
